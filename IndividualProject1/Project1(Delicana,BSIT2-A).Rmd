...
```{}
#Set-up a credentials by generating the tokens and keys from the created app. 
It need to have an elevated access.
...
ACCESS_TOKEN <- "AAAAAAAAAAAAAAAAAAAAABwCjw
EAAAAAQfvWT49egbSWWezPRVXkzJmUASc%3DhXMsIEGBz
Oy7f0rb2wH9f9iHWEgsTAR9GFGH0U7Ea1iQkxNlsz"
```
...
```{}
#Make a wordcloud
word_cloud <- read_excel("C:\Users\CarlF\Desktop\ISAT U Outputs\2nd Year\1st Sem
\CS 101\Final(s)\Project1(WordCloud).xlsx")
View(word_cloud)
attach(word_cloud)
labels(word_cloud)
